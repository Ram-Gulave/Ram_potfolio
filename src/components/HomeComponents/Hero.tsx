...
function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-screen bg-[#0f0f0f] flex items-center justify-center overflow-hidden px-6"
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto w-full text-center space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <a
            href="#contact"
            className="px-2 py-1.5 bg-gray-800 text-white rounded-md font-bold hover:bg-gray-700 transition-all text-md"
          >
            Get in Touch
          </a>
        </div>
